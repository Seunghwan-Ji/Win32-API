...
void CTile::render(HDC _dc)
{
	...
	// 선택한 타일의 순번 m_iImgIdx 이 해당하는 행, 열 계산.
	UINT iCurRow = (UINT)m_iImgIdx / iMaxCol; // ex) 순번 47 을 '최대 열'로 나눈 몫.
	UINT iCurCol = (UINT)m_iImgIdx % iMaxCol; // ex) 순번 47 을 '최대 열'로 나눈 나머지.
